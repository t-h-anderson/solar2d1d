...
while ...
  ...
  if initialization || reinitialization
    ...
    for memberNr = 1:NP
      ...
      % evaluate member
     [val(memberNr), subval(memberNr,:), pop(memberNr,:), nfeval, allval, allsubval, allmem] = computeevaluationvalue(...
  ...
  for memberNr = 1:NP
    ...
    [tempval, subtempval, popnew(memberNr,:), nfeval, allval, allsubval, allmem] = computeevaluationvalue(...
    ...
    if saveHistory
      saveoptimizationstate(...
        paramDefCellInput, paramDefCell, parameterDimVector, optimInfo, bestval, bestmem, ...
        bestvalhist, bestmemhist, valstddevhist, paramstddevhist, pop, val, subtempval, startTime, state, ...
