...
clear all;
clc;
VEg12=[1,1.1,1.15,1.2,1.3,1.4,1.5];
lambda12=[300,350,400,450,500,55,600,650,700,750,800,850,900,950,1000,1050,1100,1150,1200];
Veg13=interp1([0.95, 2],VEg12);
disp(Veg13);
CZTS=xlread('./CZTS1.xlsx');
disp(CZTS);
if size(lambda12,2)>size(lambda12,1)
    lambda12 = lambda12.';
end
disp(lambda12);
if size(Veg13,1)>size(Veg13,2)
   Veg13 = Veg13.';
end
ee = 1240./lambda12;
disp(ee);

xin = interp1([0.947, 1.5], [0, 1], Veg13);
disp(xin);
